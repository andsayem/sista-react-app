  ...
  renderRow = ({ item , index }) => {  
    return(
      ...
      style={{marginHorizontal:12,flexWrap: "wrap", padding : 0 , margin : 0 , marginRight : 4  , marginLeft  : 3}}  > 
        <TouchableOpacity onPress={() => this.props.handlePostCate(item.id)} 
        ...
        <Text onPress={() => this.handlePostCate(item.id)} style={{ textAlign : 'center' , width : '100%'}} >{item.cat_name}</Text>
      </ListItem.Content> 
      </ListItem> 

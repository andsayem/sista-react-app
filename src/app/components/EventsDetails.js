...
export default class EventsDetails extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            img: this.props.route.params.item.bg_style_image == 'event_bg_1.png' ? require('../../assets/img/bg/event_bg_1.png') : require('../../assets/img/bg/event_bg_2.png')
        };
          ...
          containerStyle={{
            ...
            height : 90
                ...
                <View  onPress={() => this.eventRegister()}  style={{ textAlign: 'center', }}>
                    <Image style={{ alignSelf: 'center' }} source={require('../../assets/img/bg/event_register_now.png')} />
                </View>
            </View>
        );
    }

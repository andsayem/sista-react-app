...
import { View, Text, ScrollView , ImageBackground , SafeAreaView ,StyleSheet , ToastAndroid, TouchableOpacity, Platform } from "react-native"; 
    ...
    return ( <SafeAreaView>
        ...
        <ScrollView horizontal style={{ marginRight: 0, width:'100%',  marginTop: 10 }} >
            <View style={{ width : 120}} >
              <Avatar rounded size="medium" source={this.state.userData ? {uri: this.state.userData.pro_image } : require('../img/images/user_1.jpg')} />
